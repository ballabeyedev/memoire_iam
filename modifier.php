...
<body>
    ...
    <div class="img">
        ...
        <img src="image/mm.png" height="200px">
    </div>
    ...
    <?php
        ...
        $sql = "SELECT id_memoire, titre, description, date_publication,fichier  FROM memoires LIMIT $offset, $itemsPerPage";
        $result = $conn->query($sql);

        if ($result->num_rows > 0) {
            echo "<table><tr><th>id</th><th>Titre</th><th>Description</th><th>Date de Publication</th><th>FICHIER</th><th>Actions</th></tr>";
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td><a href='" . $row["fichier"] . "'>Le fichier</a></td>
                        <td>
                            <a href='modifier_memoire.php?id=" . $row['id_memoire'] . "'>Modifier</a>
                        </td>
                    </tr>";
            }
            echo "</table>";
